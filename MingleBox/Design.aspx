<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Design.aspx.cs" Inherits="Design" %>
         ...
         <div class="col-md-12">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT college_id, college_name, college_stream, college_feature, college_state, college_city, college_url, college_img_link, college_desc FROM college_master_tbl WHERE (college_stream = 'Design')" >
                      </asp:SqlDataSource>
                     <div class="col">                        
