<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DesignExam.aspx.cs" Inherits="DesignExam" %>
         ...
         <div class="col-md-12">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [exam_master_tbl] WHERE ([exam_stream] = 'Design')" >
                      </asp:SqlDataSource>
                     <div class="col">
